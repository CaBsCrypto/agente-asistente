...
const capabilities: readonly AvalancheCapability[] = [
  ...
  { id: "x402.report.purchase", provider: "0xGasless", title: "Purchase an x402 report", description: "Authorize 0.01 Fuji USDC with EIP-3009 and sponsored gas.", status: "ready_to_test", operation: "financial", approval: "privy_single", network: "avalanche:fuji", requires: ["privy_session", "evm_wallet", "fuji_usdc"], evidence: "Discovery, signature binding, settlement and duplicate guards pass automated tests.", nextAction: "Complete the authenticated regression test with a fresh Privy user." },
