...
export default function Home(){return <main>
  <nav className="nav shell"><a className="brand" href="#top"><b>AA</b>agent-assistant</a><div><a href="#product">Product</a><a href="#pilots">Pilots</a><a href="/developers">Developers</a><a href="#partners">Partners</a></div></nav>
