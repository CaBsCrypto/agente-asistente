...
const pilots=[
  ...
  ["Private access","UNBLCK","Discover programs, request access and complete assisted onboarding."],
  ["Digital work","ArcusX","Turn a brief and budget into a trackable job with escrow and delivery evidence."],
  ["Global travel","Travala","Search and prepare travel options through MCP before enabling paid booking."],
];
export default function Home(){return <main>
  <nav className="nav shell"><a className="brand" href="#top"><b>AA</b>agent-assistant</a><div><a href="#product">Product</a><a href="/demo">Live Demo</a><a href="#pilots">Pilots</a><a href="/developers">Developers</a><a href="/connections">Integration Lab</a><a href="/waitlist">Waitlist</a><a className="nav-login" href="/login">Sign in</a></div></nav>
  <section className="hero shell" id="top"><div><p className="eyebrow">COMMERCE INFRASTRUCTURE FOR AI AGENTS</p><h1>Agents can take action. <em>You stay in control.</em></h1><p className="lede">A non-custodial control layer for agents that discover, book, hire and pay under policies defined by real people.</p><div className="actions"><a href="/login">Sign in to your agent</a><a href="/demo">Try the live demo</a></div><small>Privy identity + native Stellar wallet | Testnet only | No real funds enabled</small></div>
  <aside><header><span>Action ready for review</span><b>TESTNET</b></header><p>Reserve a workspace for tomorrow and prepare a 20 USDC vault deposit.</p><dl><div><dt>Maximum budget</dt><dd>60 USDC</dd></div><div><dt>This action</dt><dd>20 USDC</dd></div><div><dt>Network</dt><dd>Stellar</dd></div></dl><strong className="approved">Policy checks passed</strong><a className="hero-demo-link" href="/demo">Open live action console</a><small>Your private key never reaches our server.</small></aside></section>
