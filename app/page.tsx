...
export default function Home(){return <main>
  <nav className="nav shell"><a className="brand" href="#top"><b>AA</b>agent-assistant</a><div><a href="/agent">Open Agent</a><a href="/demo">Live Demo</a><a href="#pilots">Pilots</a><a href="/developers">Developers</a><a href="/connections">Integration Lab</a><a href="/waitlist">Waitlist</a></div></nav>
  <section className="hero shell" id="top"><div><p className="eyebrow">COMMERCE INFRASTRUCTURE FOR AI AGENTS</p><h1>Agents can take action. <em>You stay in control.</em></h1><p className="lede">A non-custodial control layer for agents that discover, book, hire and pay under policies defined by real people.</p><div className="actions"><a href="/agent">Create your agent</a><a href="/demo">Try the live demo</a></div><small>Automatic Privy identity + Stellar wallet | Testnet only | No real funds enabled</small></div>
