...
const copy = {
  en: {
    ...
    statusRows: [["Public commerce MCP", "Sandbox live"], ["Provider MCP", "Pilot ready"], ["Personal agent MCP", "Development bridge"], ["DeFindex signing", "Live Testnet proof"], ["Mainnet settlement", "Disabled"]],
  ...
  es: {
    ...
    statusRows: [["MCP de comercio público", "Sandbox activo"], ["Provider MCP", "Piloto listo"], ["MCP del agente personal", "Puente de desarrollo"], ["Firma DeFindex", "Prueba Testnet activa"], ["Liquidación Mainnet", "Desactivada"]],
  ...
  pt: {
    ...
    statusRows: [["MCP de comércio público", "Sandbox ativo"], ["Provider MCP", "Piloto pronto"], ["MCP do agente pessoal", "Ponte de desenvolvimento"], ["Assinatura DeFindex", "Prova Testnet ativa"], ["Liquidação Mainnet", "Desativada"]],
